package devils.dare.webs.base.serenity;
...
public class SerenityBaseWebPage extends PageObject {
    ...
    protected void waitForVisible(WebElementFacade element, long timeout) {
    ...
    protected void waitForInvisible(WebElementFacade element, long timeout) {
    ...
    protected void waitForClickable(WebElementFacade element, long timeout) {
    ...
    protected boolean isVisible(By byObj) {
        ...
        WebElementFacade el = getElement(byObj);
        return el != null && el.isDisplayed();
    }

    protected boolean isVisible(WebElementFacade element) {
    ...
    protected boolean isEnabled(WebElementFacade element) {
        waitForVisible(element, TIMEOUT);
    ...
    protected boolean isSelected(WebElementFacade element) {
        waitForVisible(element, TIMEOUT);
    ...
    protected boolean isNotVisible(By byObj) {
        ...
        return !getElement(byObj).isVisible();
    }

    protected boolean isNotVisible(WebElementFacade element) {
    ...
    protected void sendKeys(WebElementFacade element, CharSequence... string) {
        waitForVisible(element, TIMEOUT);
        element.sendKeys(string);
    }

    protected void clear(By byObj) {
        WebElementFacade element = getElement(byObj);
        element.clear();
    }

    protected void clear(WebElementFacade element) {
        waitForVisible(element, TIMEOUT);
        element.clear();
    }
    ...
    protected void submit(WebElementFacade element) {
        waitForClickable(element, TIMEOUT);
        element.submit();
    }

    protected WebElementFacade getElement(By byObj) {
        waitForClickable(byObj, TIMEOUT);
        return element(byObj);
    }

    protected List<WebElementFacade> getElements(By byObj) {
        return $$(byObj);
    }
    ...
    protected String text(WebElementFacade element) {
        waitForClickable(element, TIMEOUT);
    ...
    protected List<String> texts(List<WebElementFacade> element) {
        return element.stream().map(WebElementFacade::getText).toList();
    }
    ...
    protected String cssValue(WebElementFacade element, String cssKey) {
        waitForVisible(element, TIMEOUT);
    ...
    protected String attribute(WebElementFacade element, String attr) {
        waitForVisible(element, TIMEOUT);
    ...
    protected String className(WebElementFacade element) {
        waitForVisible(element, TIMEOUT);
