...
import rest.cucumber.pojo.models.Colors;
...
//	@Test
    ...
    public static class JPaths {
        public static void queryPath(String query, String json) {
            try {
                System.out.print(rest.cucumber.pojo.models.Colors.Purple + query + " => ");
                System.out.println(rest.cucumber.pojo.models.Colors.Green + JsonPath.from(json).get(query));
            } catch (Exception e) {
